...
${OBJECTDIR}/_ext/7daaf93a/md5.o: ../Common/md5.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Common -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7daaf93a/md5.o ../Common/md5.cpp

${OBJECTDIR}/_ext/7daaf93a/mdFile.o: ../Common/mdFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/7daaf93a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Common -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7daaf93a/mdFile.o ../Common/mdFile.cpp

${OBJECTDIR}/_ext/7daaf93a/mdf4.o: ../Common/mdf4.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/7daaf93a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Common -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7daaf93a/mdf4.o ../Common/mdf4.cpp

${OBJECTDIR}/ImportMdf4.o: ImportMdf4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Common -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImportMdf4.o ImportMdf4.cpp

${OBJECTDIR}/MDF4_SimpleReader.o: MDF4_SimpleReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Common -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MDF4_SimpleReader.o MDF4_SimpleReader.cpp

${OBJECTDIR}/stdafx.o: stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Common -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stdafx.o stdafx.cpp
